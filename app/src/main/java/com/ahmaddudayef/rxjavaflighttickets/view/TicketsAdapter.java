package com.ahmaddudayef.rxjavaflighttickets.view;
...
import com.ahmaddudayef.rxjavaflighttickets.R;
...
public class TicketsAdapter extends RecyclerView.Adapter<TicketsAdapter.MyViewHolder> {
    ...
    @Override
    public void onBindViewHolder(TicketsAdapter.MyViewHolder holder, int position) {
